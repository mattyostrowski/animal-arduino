...
void handleCommandLineForSensor(const String& command) {
    if (command == "initstart") {
        r->setSensor(eInitSen);
        delay(500);
        r->setSensor(eStartSen);
        delay(200);
        // Print statuses here
...
//Usage example from serial console: "A initstart" or "B initstart".
